...
class CustomDataset(Dataset):
    def __init__(self):
        self.imgs_path = "/data/bpeng2/bpeng2/pythonProject1/ImageNet1000/train"
        cache_path = "./data_train"

        # self.imgs_path = "/data/bpeng2/bpeng2/pythonProject1/ImageNet1000/val"
        # cache_path = "./data_val"
