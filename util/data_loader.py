...
def get_loader_in(args, config_type='default', split=('train', 'val')):
    ...
    if args.in_dataset == "CIFAR-10":
        # Data loading code
        if 'train' in split:
            trainset = torchvision.datasets.CIFAR10(root='/data/bpeng2/bpeng2/pythonProject1/cider-master/datasets/CIFAR10', train=True, download=True, transform=config.transform_train)
            train_loader = torch.utils.data.DataLoader(trainset, batch_size=config.batch_size, shuffle=True, **kwargs)
        if 'val' in split:
            valset = torchvision.datasets.CIFAR10(root='/data/bpeng2/bpeng2/pythonProject1/cider-master/datasets/CIFAR10', train=False, download=True, transform=transform_test)
            val_loader = torch.utils.data.DataLoader(valset, batch_size=config.batch_size, shuffle=True, **kwargs)
    elif args.in_dataset == "CIFAR-100":
        # Data loading code
        if 'train' in split:
            trainset = torchvision.datasets.CIFAR100(root='/data/bpeng2/bpeng2/pythonProject1/cider-master/datasets/CIFAR100', train=True, download=True, transform=config.transform_train)
            train_loader = torch.utils.data.DataLoader(trainset, batch_size=config.batch_size, shuffle=True, **kwargs)
        if 'val' in split:
            valset = torchvision.datasets.CIFAR100(root='/data/bpeng2/bpeng2/pythonProject1/cider-master/datasets/CIFAR100', train=False, download=True, transform=config.transform_test)
            val_loader = torch.utils.data.DataLoader(valset, batch_size=config.batch_size, shuffle=True, **kwargs)
    elif args.in_dataset == "imagenet":
        root = '/data/bpeng2/bpeng2/pythonProject1/ImageNet1000'
        # Data loading code
        if 'train' in split:
...
def get_loader_out(args, dataset=('tim', 'noise'), config_type='default', split=('train', 'val')):
    ...
    if 'val' in split:
        ...
        if val_dataset == 'SVHN':
            val_ood_loader = torch.utils.data.DataLoader(SVHN('/data/bpeng2/bpeng2/pythonProject1/cider-master/datasets/small_OOD_dataset/svhn', split='test', transform=transform_test, download=False),
            ...
            val_ood_loader = torch.utils.data.DataLoader(torchvision.datasets.ImageFolder(root="/data/bpeng2/bpeng2/pythonProject1/cider-master/datasets/small_OOD_dataset/dtd/images", transform=transform),
                                                       batch_size=batch_size, shuffle=True, num_workers=2)
        elif val_dataset == 'places365':
            val_ood_loader = torch.utils.data.DataLoader(torchvision.datasets.ImageFolder(root="/data/bpeng2/bpeng2/pythonProject1/cider-master/datasets/small_OOD_dataset/places365", transform=transform_test),
                                                       batch_size=batch_size, shuffle=True, num_workers=2)
            ...
            val_ood_loader = torch.utils.data.DataLoader(
                torchvision.datasets.ImageFolder("/data/bpeng2/bpeng2/pythonProject1/cider-master/datasets/large_OOD_dataset/Places",
                                                 transform=config.transform_test_largescale), batch_size=batch_size,
                shuffle=False, num_workers=2)
        elif val_dataset == 'sun50':
            val_ood_loader = torch.utils.data.DataLoader(
                torchvision.datasets.ImageFolder("/data/bpeng2/bpeng2/pythonProject1/cider-master/datasets/large_OOD_dataset/SUN",
                                                 transform=config.transform_test_largescale), batch_size=batch_size,
                shuffle=False,
                num_workers=2)
        elif val_dataset == 'inat':
            val_ood_loader = torch.utils.data.DataLoader(
                torchvision.datasets.ImageFolder("/data/bpeng2/bpeng2/pythonProject1/cider-master/datasets/large_OOD_dataset/iNaturalist",
                                                 transform=config.transform_test_largescale), batch_size=batch_size,
                shuffle=False,
                num_workers=2)
            ...
            val_ood_loader = torch.utils.data.DataLoader(torchvision.datasets.ImageFolder("/data/bpeng2/bpeng2/pythonProject1/cider-master/datasets/small_OOD_dataset/{}".format(val_dataset),
