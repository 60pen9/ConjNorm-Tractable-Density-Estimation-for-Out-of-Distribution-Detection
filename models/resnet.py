...
def resnet18(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        checkpoint = torch.load(f"C:checkpoints//waterbirds//resnet18//checkpoint_1002.ckpt")
        checkpoint2 = {'state_dict': {}}
        for key, value in checkpoint.items():
            if key.startswith("backbone"):
                checkpoint2["state_dict"][key.replace("backbone.", "")] = value
            else:
                checkpoint2["state_dict"][key.replace("head.", "")] = value
