...
feat_log_val = np.load("./imagenet_resnet/imagenet_feature_resnet_50/val.npy")# you should load from your own address
...
for k in range(class_num):
    k_ftrain = np.load("./imagenet_resnet/imagenet_feature_resnet_50/class_{k}.npy".format(k=k)) # you should load from your own address
